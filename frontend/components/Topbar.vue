        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <button @click="toggleMenu" type="button"
                        class="btn btn-sm px-3 font-size-16 header-item vertical-menu-btn" id="vertical-menu-btn">
            ...
            <div class="d-flex">
                <b-dropdown variant="white" class="d-inline-block d-lg-none ms-2" toggle-class="header-item noti-icon"
                            right menu-class="dropdown-menu-lg p-0 dropdown-menu-end">
                ...
                <b-dropdown class="d-inline-block" toggle-class="header-item" right variant="white"
                    ...
                    <a class="dropdown-item" @click.prevent="logoutUser" href="">
