...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                domain: [
                    { required: true, message: 'The domain field is required' },
                ]
            },
            loading: false,
    ...
    methods: {
        ...
        async addNew() {
            this.loading = true;
            await this.$axios.post('websites', this.formData)
            .then(response => {
        ...
        async update() {
            this.loading = true;
            await this.$axios.patch(`websites/${this.formData.id}`, this.formData)
                .then(response => {
